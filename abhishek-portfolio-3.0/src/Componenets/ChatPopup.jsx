...
export default function ChatPopup(props) {
  ...
  return (
    <>
      <div className="lg:w-80 w-60 lg:h-96 border border-[#59d0b4] fixed bottom-24 sm:right-12 right-8 z-20 rounded-xl bg-white flex flex-col justify-center items-center dark:bg-[#121212] dark:text-white shadow-lg shadow-[#88ffe563]">
        ...
        <div className="w-full h-4/5 px-8 py-5 flex flex-col overflow-y-auto">
          <div className="w-full relative">
            <p className="w-fit border border-[#c9c9c9] rounded-3xl px-5 py-3 text-sm z-0 shadow-2xl">
              Hi there, sorry we are unavailable at the moment. Please leave your
        ...
        <div className="flex py-3 px-3 w-full sm:justify-evenly justify-between border-t-2 border-[#e6e6e6]">
          ...
          <SendIcon
            ...
            className="sm:w-14 w-12 bg-[#59d0b4] text-white sm:px-4 px-3 sm:py-1 rounded-full cursor-pointer"
          />
        </div>
      </div>
      <div></div>
