  ...
  return (
    <>
      <Navbar
        ...
        maxWidth="2xl"
        className={`border-b-1 ${darkMode ? "dark text-white border-[#3D4852] bg-[#18181b]" : ""}`}
      >
        <NavbarContent>
          <NavbarMenuToggle
        ...
        <NavbarMenu className={`w-1/2 border-1 rounded-lg bg-transparent dark:border-white ${darkMode ? "dark" : ""}`}>
      ...
      >
        ...
        />
        {isOpen && (
          <Card shadow="lg" className="fixed border-1 border-[#ffa200] right-5 bottom-20 max-w-[300px] max-h-[450px] m-3 z-30 after:content-[''] after:bg-inherit after:w-5 after:h-5 after:absolute after:-bottom-[10px] after:right-7 after:rotate-45 overflow-visible after:border-b-1 after:border-r-1 after:border-[#ffa200]">
            ...
            <CardBody className="relative h-[40vh] font-josefin">
              <div className="h-full flex flex-col justify-between items-end">
                <Card shadow="lg" className=" m-4 p-5 dark:border-[#3D4852] dark:border-1 after:content-[''] after:bg-inherit after:w-5 after:h-5 after:absolute after:bottom-6 after:-left-[11px] after:rotate-45 overflow-visible dark:after:border-[#3D4852] after:border-b-1 after:border-l-1 ">
      ...
      >
        <Link target="_blank"to="https://www.linkedin.com/in/abhishek-vishwakarma-127b66227/">
        ...
        <Link target="_blank"to="https://wa.me/7235047144?text=Hello, I find you by your portfolio">
