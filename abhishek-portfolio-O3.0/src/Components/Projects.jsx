      ...
      >
        ...
        >
          ...
          <CardBody className="font-josefin">
            ...
            <div className="flex flex-col md:flex-row py-4 gap-10 items-center">
              <img
                className="md:hover:scale-125 duration-250 w-80 h-44 z-10 block md:hidden"
            ...
            <div className="flex flex-col md:flex-row py-4 gap-10 items-center ">
              <img
                className="md:hover:scale-125 duration-250 w-[400px] h-48 z-10 block md:hidden"
              ...
              />
              <img
                className="md:hover:scale-125 duration-250 w-[400px] h-44 z-10 hidden md:block"
                src="./images/login-form.png"
                alt="loading..."
              />
            </div>
